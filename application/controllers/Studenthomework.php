...
class Studenthomework extends CI_Controller
 {
	...
	{
		 parent::__construct();
		  $this->load->model('studenthomeworkmodel');
	  ...
	  public function homework_view()
	   {       
			...
			//echo $user_id;
			$datas['result'] = $this->studenthomeworkmodel->get_stu_homework_details($user_id);
	  ...
	  { 
			...
			$datas['res'] = $this->studenthomeworkmodel->view_homework_marks($user_id,$hw_id);
		...
		public function exam_views()
		{
			    $datas=$this->session->userdata();
  	 		    $user_id=$this->session->userdata('user_id');
				$user_type=$this->session->userdata('user_type');
				$datas['exam']=$this->studenthomeworkmodel->get_all_exam($user_id);
		...
		public function exam_result($exam_id)
		{
			...
			$user_id=$this->session->userdata('user_id');
			$user_type=$this->session->userdata('user_type');
			$datas['result']=$this->studenthomeworkmodel->exam_marks($user_id,$exam_id);
