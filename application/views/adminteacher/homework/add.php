...
<div class="content">
                              ...
                              <?php
                                ...
                                <div class="col-md-2"><p>No Records Found</p></div>
                                  ...
                                  <?php   $cnt= count($class_id);
                                   ...
                                   ?>
                              <div class="col-md-2">
            <a rel="tooltip" href="" onclick="changeText(<?php echo $class_id[$i]; ?>)" data-toggle="modal" data-target="#addmodel" data-id="<?php echo $class_id[$i]; ?>"  class=" open-AddBookDialog  btn btn-wd"><?php echo $class_name[$i]."-".$sec_name[$i]; ?></a></div>
                              <?php  } }  ?>
                              </div>
   ...
   <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
       ...
       <a href="<?php echo base_url();  ?>" class="btn btn-simple btn-warning btn-icon edit"><i class="fa fa-edit"></i></a>									
                                      </td>
                                  </tr>
                                  <?php $i++;  }  ?>
                              </tbody>
